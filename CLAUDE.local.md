...
**YOU ARE IN: `hermes_metal/polecats/nux/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/hermes_metal/` (rig root) or other directories
...
**Your mail address:** `hermes_metal/polecats/nux`
**Your rig:** hermes_metal
**Your Witness:** `hermes_metal/witness`
...
| Ask Witness for help | `gt mail send hermes_metal/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`hermes_metal/witness`) when:
...
```bash
gt mail send hermes_metal/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
